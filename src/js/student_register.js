    ...
    App.contracts.Election.deployed().then(function(instance) {
      ...
      for (var i = 1; i <= candidatesCount; i++) {
        electionInstance.getdept(i).then(function(candidate) {
          ...
          var candidateTemplate="<option value='"+name+"'>"+name+"</option>"
...
App.contracts.student.deployed().then(function(instance) {
  ...
  return adoptionInstance.registerStudent(name,birthdate,department,address,email,mobile,password,program, {from: account});
  ...
  x.then(function(value) {
    ...
    if(id1!=0)
    {
      document.getElementById("disp").innerHTML="Account Created Successfully. <a href='student_login.html'>Click to go to the Login Page</a>";
        
    }
    else
    {
        document.getElementById("disp").innerHTML="Error!!Account not Created Successfully. <a href='student_register.html'>Click to go the Student Registration Page</a>";
